...
<template>
  <article class="mb-2 flex items-center">
    ...
    <span
      v-if="complete"
      class="inline-flex items-center bg-green-50 dark:bg-green-950 mr-2 px-2 py-1 text-xs font-medium text-green-500 dark:green-sky-300 ring-1 ring-inset ring-green-700/10 dark:ring-green-100/10"
      >Done</span
    >
