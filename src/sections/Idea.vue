...
<template>
  <article class="flex items-center space-x-2">
    <span
      class="inline-flex items-center bg-sky-50 dark:bg-sky-950 px-2 py-1 text-xs font-medium text-sky-500 ring-1 ring-inset ring-sky-700/10 dark:ring-sky-100/10"
      >Idea</span
    >
    <span
