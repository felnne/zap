...
> [!NOTE]
> In August 2026 and starting in version 0.24.0, this project began to migrate to a Streamlit reimplementation.
> Change log entries and releases before this describe the initial VueJS based implementation.
...
* Experimental Streamlit application with basic record IO, preview and validation
...
* Including prefix in alias identifiers
